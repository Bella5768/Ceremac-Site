...
if CustomUser.objects.filter(username='admin').exists():
    ...
    admin_user.email = 'admin@ceremac.edu.gn'
...
print(f"  - Interface d'administration: https://ceremac.edu.gn/admin/")
print(f"  - Page de connexion: https://ceremac.edu.gn/login/")
